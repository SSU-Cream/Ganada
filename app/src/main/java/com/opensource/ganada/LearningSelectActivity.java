...
public class LearningSelectActivity extends AppCompatActivity {
    ...
    public void show_register_student_dlg() {
        View dlgView = (View)View.inflate(LearningSelectActivity.this, R.layout.register_student, null);
        AlertDialog.Builder register_student_dlg = new AlertDialog.Builder(LearningSelectActivity.this);
